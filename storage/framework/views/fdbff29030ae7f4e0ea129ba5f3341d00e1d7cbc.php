                                    ...
                                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                        <div class="swiper-slide swiper-slide-active">
                                            <div class="bg-img-holder top-0 right-0 col-12" data-bg-size="cover" style="background-image: url('<?php echo e(asset('landing/img/laptop-banner.png')); ?>'); background-position: initial; background-size: cover; opacity: 1; height: 100%;">
                                                <img alt="Image placeholder" src="<?php echo e(asset('landing/img/laptop-banner.png')); ?>">
                                            </div>
                                        </div>
                                    </div>
    ...
    <section class="slice slice-lg" id="features">
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6">
                    <img alt="Image placeholder" src="<?php echo e(asset('landing/img/product-1.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6 order-lg-1">
                    <img alt="Image placeholder" src="<?php echo e(asset('landing/img/product-2.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
    <section class="slice slice-lg">
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6">
                    <img alt="Image placeholder" src="<?php echo e(asset('landing/img/product-3.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
    <section class="slice slice-lg">
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6 order-lg-1">
                    <img alt="Image placeholder" src="<?php echo e(asset('landing/img/product-4.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
...
<?php /**PATH E:\Program Files\xampp\htdocs\TaskGo\resources\views/layouts/landing.blade.php ENDPATH**/ ?>