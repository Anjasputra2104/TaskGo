                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" class="custom-control-input" name="enable_stripe" id="enable_stripe" {{(isset($payment_detail['enable_stripe']) && $payment_detail['enable_stripe'] == 'on') ? 'checked' : ''}}>
                                        ...
                                        <div id="collapse-paypal" class="collapse" aria-labelledby="paypal-payment" data-parent="#payment-gateways">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" class="custom-control-input" name="enable_paypal" id="enable_paypal" {{(isset($payment_detail['enable_paypal']) && $payment_detail['enable_paypal'] == 'on') ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="ml-2">{{__('Image Screenshort Take Interval time ( 1 = 1 min)')}}</small>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {{-- {{ Form::text('', $details['address'], ['class' => 'form-control','required' => 'required']) }} --}}
                                    <input type="text" name="zoom_api_key"   placeholder="Zoom API Key" value="{{ !empty($details['zoom_api_key']) ? $settings['zoom_api_key'] : '' }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    value="{{ !empty($details['zoom_secret_key']) ? $details['zoom_secret_key'] : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="text-right">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            ...
                                            {{Form::checkbox('is_project_enabled', '1',isset($settings['is_project_enabled']) && $settings['is_project_enabled'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'is_project_enabled'))}}
                                    ...
                                    <li class="list-group-item"> 
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('invoice_notificaation', '1',isset($settings['invoice_notificaation']) && $settings['invoice_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'invoice_notificaation'))}}
                            ...
                            <div class="col-md-6">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('task_move_notificaation', '1',isset($settings['task_move_notificaation']) && $settings['task_move_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'task_move_notificaation'))}}
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('mileston_notificaation', '1',isset($settings['mileston_notificaation']) && $settings['mileston_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'mileston_notificaation'))}}
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('milestone_status_notificaation', '1',isset($settings['milestone_status_notificaation']) && $settings['milestone_status_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'milestone_status_notificaation'))}}
                                            <label class="custom-control-label" for="milestone_status_notificaation"></label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <span> {{__('Invoice status changes')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('invoice_status_notificaation', '1',isset($settings['invoice_status_notificaation']) && $settings['invoice_status_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'invoice_status_notificaation'))}}
                                            <label class="custom-control-label" for="invoice_status_notificaation"></label>
                                        </div>
                                    </li>
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            ...
                                            {{Form::checkbox('telegram_is_project_enabled', '1',isset($settings['telegram_is_project_enabled']) && $settings['telegram_is_project_enabled'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'telegram_is_project_enabled'))}}
                                    ...
                                    <li class="list-group-item"> 
                                        <span>{{__('Invoice create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_invoice_notificaation', '1',isset($settings['telegram_invoice_notificaation']) && $settings['telegram_invoice_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'telegram_invoice_notificaation'))}}
                                            <label class="custom-control-label" for="telegram_invoice_notificaation"></label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Task move')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_task_move_notificaation', '1',isset($settings['telegram_task_move_notificaation']) && $settings['telegram_task_move_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'telegram_task_move_notificaation'))}}
                                            <label class="custom-control-label" for="telegram_task_move_notificaation"></label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <span> {{__('Milestone create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_mileston_notificaation', '1',isset($settings['telegram_mileston_notificaation']) && $settings['telegram_mileston_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'telegram_mileston_notificaation'))}}
                                            <label class="custom-control-label" for="telegram_mileston_notificaation"></label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <span> {{__('Milestone status updated')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_milestone_status_notificaation', '1',isset($settings['telegram_milestone_status_notificaation']) && $settings['telegram_milestone_status_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'telegram_milestone_status_notificaation'))}}
                                            <label class="custom-control-label" for="telegram_milestone_status_notificaation"></label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <span> {{__('Invoice status changes')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_invoice_status_notificaation', '1',isset($settings['telegram_invoice_status_notificaation']) && $settings['telegram_invoice_status_notificaation'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'telegram_invoice_status_notificaation'))}}
                                            <label class="custom-control-label" for="telegram_invoice_status_notificaation"></label>
                                        </div>
                                    </li>
