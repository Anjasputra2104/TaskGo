<nav class="navbar navbar-main navbar-expand-lg navbar-dark bg-primary navbar-border" id="navbar-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-fade" id="navbar-main-collapse">
            @if(\Auth::user()->type != 'admin')
                <span class="navbar-nav align-items-lg-center text-white">
                    <li class="nav-item tracking-clock">
                    ...
                    <li class="nav-item timer-counter"></li>
                    <li class="nav-item start-task"></li>
                    <li class="nav-items">
                        <a href="{{ url('chats') }}" class="">
                            <span><i class="fas fa-comment" style="font-size: 21px; color:blue; padding-top:6px";></i></span>
