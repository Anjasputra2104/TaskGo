            ...
            @if (trim($__env->yieldContent('title')) != 'Task Calendar')
                <div class="page-title">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 d-md-flex d-block align-items-center justify-content-between justify-content-md-end rounded_icon">
                            @yield('action-button')
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center text-sm-left align-items-sm-center">
                    ...
                    <div class="col-sm-6 mb-md-0">
                        <ul class="nav justify-content-center justify-content-md-end">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ \App\Models\Utility::getValByName('footer_value_1') }}">{{ \App\Models\Utility::getValByName('footer_link_1') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ \App\Models\Utility::getValByName('footer_value_2') }}">{{ \App\Models\Utility::getValByName('footer_link_2') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ \App\Models\Utility::getValByName('footer_value_3') }}">{{ \App\Models\Utility::getValByName('footer_link_3') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
