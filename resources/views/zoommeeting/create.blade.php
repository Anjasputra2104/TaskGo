...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        {{ Form::select('employee[]',[], false, array('class' => 'form-control employee_select','data-toggle'=>'select2','multiple'=>'','required'=>'required')) }}
    </div>
    ...
    <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-6 client" style="display: none">
            ...
            {{ Form::select('client_id[]',[], false, array('class' => 'form-control client_select','data-toggle'=>'select2','multiple'=>'')) }}
        </div>
    </div>
</div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data.clients, function (i, item) {
                        $('.client_select').append('<option value="' + item.id + '">' + item.name + '</option>');
                    });
                    if (data == '') {
                        $('.employee_select').empty();
                        $('.client_select').empty();
